...
$(document).ready(function(){
	...
	$('.menu li.about').click(function(){
		$('html, body').animate({
	        scrollTop: $(".section.about-us").offset().top -40
	    }, 500);
	});
	$('.menu li.services').click(function(){
		$('html, body').animate({
	        scrollTop: $(".section.services").offset().top -40
	    }, 500);
	});
	$('.menu li.technologies').click(function(){
		$('html, body').animate({
	        scrollTop: $(".section.technologies").offset().top -40
	    }, 500);
	});
	$('.menu li.why').click(function(){
		$('html, body').animate({
	        scrollTop: $(".section.why").offset().top -40
	    }, 500);
	});
